...
var TEXT_PATHS      = "path(s)",
    TEXT_FORMAT     = "Formats",
    TEXT_COMPRESS   = "Compressions",
    TEXT_RESIZE     = "Resize",
    TEXT_ORGSIZE    = "Original",
    TEXT_HALFSIZE   = "Half",
    TEXT_QUADSIZE   = "Quad",
    TEXT_LOWRES     = "Low-Res",
    TEXT_DOLOWRES   = "Be low-res image...",
    ...
    TEXT_DOT        = "Dot",
    TEXT_VERSION    = "Append Version | Monochrome Keywords",
    ...
    TEXT_ANALYSIS   = "Grayscale keyword Analysis...",
    TEXT_DOGRAYSCALE= "Convert monochrome successfully!",
    TEXT_GRAYSKIP   = "Skip Grayscale...",
    ...
    HELP_VAGK       = "Append version string and grayscale keywords define.",
...
function DivisionMainProc(outputMode)
{
    ...
    if(outputMode) {
        ...
        var rate = new progressRateBar(NUMVISIBLELS * rate_multi);
    }
    rate.show();
